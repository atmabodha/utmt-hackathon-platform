...
schema_view = get_schema_view(
    openapi.Info(
        title="Coding Contest API Endpoints",
        default_version='v1',
        description="These are the documentations for the different apis for the platform.",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="narayanjat2964@gmail.com"),
